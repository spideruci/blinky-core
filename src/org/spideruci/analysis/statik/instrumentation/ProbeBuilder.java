...
import static org.spideruci.analysis.statik.instrumentation.Config.TRACE_LOGGER;
...
import static org.spideruci.analysis.dynamic.TraceLogger.PROBE_WILL_START;
import static org.spideruci.analysis.dynamic.TraceLogger.PROBE_WILL_START_DESC;
...
public class ProbeBuilder implements Opcodes {
  ...
  public static ProbeBuilder start(MethodVisitor mv) {
    // Even before probe starts, signal "Probe Will Start" to the TraceLogger.
    mv.visitMethodInsn(Opcodes.INVOKESTATIC, TRACE_LOGGER, PROBE_WILL_START, PROBE_WILL_START_DESC, false);
...
//      mv.visitMethodInsn(INVOKESTATIC, STRING_DESC, "valueOf", methodDesc, false);
  ...
  private void visitLoadHash() {
    mv.visitTypeInsn(CHECKCAST, Deputy.desc2type(OBJECT_DESC));
