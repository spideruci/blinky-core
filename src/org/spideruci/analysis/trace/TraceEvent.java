...
public class TraceEvent implements Instruction, ITraceEvent {
  ...
  public static TraceEvent createVarInsnExecEvent(long id) {
   ...
   * @return
   */
  public static TraceEvent createArrayInsnExecEvent(long id) {
   ...
   * @return
   */
  public static TraceEvent createInsnExecEvent(long id) {
   ...
   * @return
   */
  public static TraceEvent createInsnEvent(long id, EventType type) {
   ...
   * @return
   */
  public static TraceEvent createDeclEvent(long id, EventType type) {
  ...
  private TraceEvent(long id, EventType type, Enum[] propNames) {
